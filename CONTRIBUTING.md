...
Proxmox VE (PVE) module for Icinga Web 2 is an open source project and lives from your ideas and contributions.
...
Please consider our [roadmap](https://github.com/nbuchwitz/icingaweb2-module-pve/milestones) and
[open issues](https://github.com/nbuchwitz/icingaweb2-module-pve/issues) when you start contributing
to the project.

Before starting your work on this Proxmox VE (PVE) module for Icinga Web 2, you should [fork the project](https://help.github.com/articles/fork-a-repo/)
...
```
git clone git@github.com:dnsmichi/icingaweb2-module-pve.git
cd icingaweb2-module-pve
```

Add a new remote `upstream` with this repository as value.

```
git remote add upstream https://github.com/nbuchwitz/icingaweb2-module-pve.git
```
...
[Icinga 2 Vagrant boxes](https://github.com/icinga/icinga-vagrant).
    ...
    $ vagrant up
    $ vagrant ssh -c "cd /usr/share/icingaweb2/modules/pve && sudo git pull"
